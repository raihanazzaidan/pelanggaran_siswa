...
(1, '1234567', 'raihan', 'r5', 500),
(4, '1234571', 'nopal', 'r5', 500),
(5, '112233', 'agus', '10', 100);
...
ALTER TABLE `detail_pelanggaran_siswa`
  ADD KEY `id_pelanggaran_siswa` (`id_pelanggaran`),
  ADD KEY `id_pelanggaran_siswa_2` (`id_pelanggaran_siswa`);
